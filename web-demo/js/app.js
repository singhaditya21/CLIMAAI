...
class ClimaAI {
    ...
    async handleLogin(e) {
        ...
        if (submitBtn) {
            ...
            submitBtn.innerHTML = '<span class="loading" style="padding: 0;">Logging in...</span>';
    ...
    async handleRegister(e) {
        ...
        if (submitBtn) {
            originalText = submitBtn.innerHTML;
            submitBtn.innerHTML = '<span class="loading" style="padding: 0;">Creating account...</span>';
            submitBtn.disabled = true;
            submitBtn.setAttribute('aria-busy', 'true');
        }
    ...
    async handleGoogleSignIn(e) {
        const submitBtn = e ? e.currentTarget : null;
        let originalText = '';
        if (submitBtn) {
            originalText = submitBtn.innerHTML;
            submitBtn.innerHTML = '<span class="loading" style="padding: 0;">Signing in...</span>';
            submitBtn.disabled = true;
            submitBtn.setAttribute('aria-busy', 'true');
        }
